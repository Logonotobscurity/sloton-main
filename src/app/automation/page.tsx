...
export const metadata = generateMetadata({
  ...
  canonical: 'https://logonai.netlify.app/automation',
});
  ...
  return (
    <div className="bg-background">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: 'Automation', url: 'https://logonai.netlify.app/automation' },
      ]} />
      <PageHero 
        kicker="Automation"
        visual="/images/marks/hero-automation.svg"
      ...
      <div className="container mx-auto px-fluid-sm py-fluid-lg">
        ...
        {/* Proof stats */}
        <section aria-label="Automation impact metrics" className="verdara-grid verdara-grid-3 mb-16">
          {stats.map(stat => (
        ...
        <section className="mb-16 md:mb-24 max-w-4xl mx-auto">
          <p className="verdara-kicker">Definition</p>
          <h2 className="verdara-title mt-2 mb-4">What is workplace <em>automation</em>?</h2>
          <p className="verdara-lede mb-6">
          ...
          <div className="verdara-grid verdara-grid-2">
            {automationTypes.map(type => (
              <article key={type.title} className="verdara-card">
                <h3>{type.title}</h3>
                <p className="verdara-lede mt-auto pt-3">{type.description}</p>
              </article>
            ))}
          </div>
        </section>
        ...
        <ServiceConceptBlock path="/automation" />
        ...
        <section className="mt-16 md:mt-24 py-12 border-t">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button asChild variant="outline" size="sm">
              <Link href="/use-cases#ecommerce">E-Commerce Workflow Automation <ArrowRight className="ml-2 h-4 w-4" /></Link>
            </Button>
            <Button asChild variant="outline" size="sm">

...
export function TechStackCarousel() {
  // Get repeated technologies for carousel effect
  const technologies = React.useMemo(() => getRepeatedTechnologies(4), []);
        ...
        <GlowingCard className="p-8 md:p-12">
            ...
            <div>
                ...
                {slider1.map((tech, index) => (
                    ...
                    <LogoImage src={tech.icon} alt={tech.name} size="sm" className="size-5" />
                    </IntegrationCard>
                ))}
                </InfiniteSlider>
            </div>

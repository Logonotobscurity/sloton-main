 ...
 * Custom SVG icons that are not available in lucide-react
 * These icons can be used across the application without creating layering violations
 */

import React from 'react';

/**
 * General/Grid icon - used for "Show All" category
 */
